...
<nav class="navbar navbar-expand-lg navbar-dark">
    <a class="navbar-brand" href="#">Kepala Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="halaman_kepala.php">Daftar Pendaftar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="pdf.php">Cetak</a>
            </li>
        </ul>
    </div>
</nav>
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="container mt-4">
        <h2 class="text-center mb-4">Selamat datang di Dashboard Kepala</h2>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
